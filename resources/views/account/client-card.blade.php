...
@section('content')
    ...
    <div class="card__buttons pb-4">
        <div class="container">
            <div class="d-flex">
                <form action="{{ route('clients.destroy', ['company_id' => $company_id, 'client' => $data[0]['id']]) }}" method="post">
                    @csrf
                    @method('delete')
                ...
                <form action="{{ route('clients.edit', ['company_id' => $company_id, 'client' => $data[0]['id']]) }}" method="get">
                    <button type="submit" class="button-circle-sm rounded-circle border-0 y-to-d me-3">
                        <div class="d-flex align-items-center justify-content-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
