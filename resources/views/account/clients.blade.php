                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="staticBackdropLabel">Создать аккаунт для клиента</h5>
            ...
            <div class="col">
                <div class="d-flex">
                    ...
                    <a class="tab rounded-top font-dark text-center font-500"
                       href="{{ route('employees.index', ['company_id' => $company_id]) }}">Сотрудники</a>
                    <a class="tab rounded-top back-light font-dark text-center font-500" href="">Клиенты</a>
                </div>
            </div>
        </div>
    </div>
