<footer class="py-5 back-dark font-light">
        <div class="container">
            <div class="row">
                        ...
                        <li class="nav-item mb-2">
                            <div class="d-flex">
                                <a href="#" class="nav-link p-0 me-3">
                                    <div class="link-circle-sm l-to-y-icon d-flex align-items-center justify-content-center">
                ...
                <div class="col">
                    <div class="fsize-20 font-500 pb-3">Информация</div>

                    <ul class="nav flex-column">
                        <li class="nav-item mb-2">
                            <a
                                href="{{ route('account.show', ['account' => \Illuminate\Support\Facades\Auth::user()->id]) }}"
                                class="nav-link p-0 link-on-dark">Аккаунт
                            </a>
                        </li>
                        <li class="nav-item mb-2">
                            <a
                                href="{{ route('clients.index') }}"
                                class="nav-link p-0 link-on-dark">Клиенты
                            </a>
                        </li>
                        <li class="nav-item mb-2">
                            <a
                                href="{{ route('requests.index') }}"
                                class="nav-link p-0 link-on-dark">Главная
                            </a>
                        </li>
                        <li class="nav-item mb-2">
                            <a
                                href=""
                                class="nav-link p-0 link-on-dark">Документация
                            </a>
                        </li>
                    </ul>
                </div>
