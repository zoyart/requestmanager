        ...
        <div class="container d-flex flex-column justify-content-center align-items-center pt-5">
            ...
            <form method="post" action="{{ route('register.store') }}" class="w-50 pb-5">
                ...
                <div class="mb-3">
                    ...
                    <div id="emailHelp" class="form-text">Мы никогда не будем делиться вашей электронной почтой с
                        кем-либо.
                    </div>
                </div>
                <div class="mb-3">
                ...
                <button type="submit" class="d-inline-block button-sm border-0 rounded-pill y-to-d">Зарегестрироваться
                </button>
            </form>
        </div>
    </div>
